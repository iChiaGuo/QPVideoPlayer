...
#import "QPSubtitleViewController.h"

@interface QPOverlayView () <QPSubtitleViewControllerDelegate>
...
@property (strong, nonatomic) QPSubtitleViewController *controller;
...
- (IBAction)showSubtitles:(id)sender {
    ...
    self.controller = [[QPSubtitleViewController alloc] initWithSubtitles:self.subtitles];
